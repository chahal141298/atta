    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .deviceInfo:
            ...
            case 1:
                ...
                cell.title.text = "Device ID"
            case 2:
                cell.deviceLabel.text = deviceDetail?.gatewayId ?? "-"
                cell.title.text = "Gateway"
            case 3:
            ...
            case 5:
                cell.deviceLabel.text = deviceDetail?.location ?? "-"
        ...
        case .treeInfo:
            ...
            case 1:
                cell.label1.text = "\(deviceDetail?.treeTiltSensor?.dbh ?? "-")m"
                cell.label2.text = "\(deviceDetail?.treeTiltSensor?.treeHeight ?? "-")m"
        ...
        case .calibration:
            ...
            //self.delegate = cell
            let currenty = deviceDetail?.treeTiltSensor?.currentY ?? 0
            cell.currentY.text = "\(currenty)"
            let currentz = deviceDetail?.treeTiltSensor?.currentZ ?? 0
