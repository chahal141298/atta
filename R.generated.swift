...
struct R: Rswift.Validatable {
  ...
  struct nib {
    ...
    /// Nib `DeviceHomeCell`.
    static let deviceHomeCell = _R.nib._DeviceHomeCell()
    /// Nib `DeviceTreeCell`.
    ...
    #if os(iOS) || os(tvOS)
    /// `UINib(name: "DeviceHomeCell", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.deviceHomeCell) instead")
    static func deviceHomeCell(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.deviceHomeCell)
    }
    #endif
    ...
    static func deviceHomeCell(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> DeviceHomeCell? {
      return R.nib.deviceHomeCell.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? DeviceHomeCell
    }
...
struct _R: Rswift.Validatable {
  ...
  struct nib: Rswift.Validatable {
    ...
    struct _DeviceHomeCell: Rswift.NibResourceType, Rswift.Validatable {
      let bundle = R.hostingBundle
      let name = "DeviceHomeCell"

      func firstView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> DeviceHomeCell? {
        return instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? DeviceHomeCell
      }

      static func validate() throws {
        if UIKit.UIImage(named: "ic_device_tree_green", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'ic_device_tree_green' is used in nib 'DeviceHomeCell', but couldn't be loaded.") }
        if UIKit.UIImage(named: "ic_pin", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'ic_pin' is used in nib 'DeviceHomeCell', but couldn't be loaded.") }
        if #available(iOS 11.0, tvOS 11.0, *) {
        }
      }
    ...
    struct _HomeCell: Rswift.NibResourceType, Rswift.Validatable {
      ...
      func thirdView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> HomeCell? {
        return instantiate(withOwner: ownerOrNil, options: optionsOrNil)[2] as? HomeCell
      }
    ...
    struct _WeatherCell: Rswift.NibResourceType, Rswift.Validatable {
      ...
      func secondView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> WeatherCell? {
        return instantiate(withOwner: ownerOrNil, options: optionsOrNil)[1] as? WeatherCell
      }
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct bottomTAB: Rswift.StoryboardResourceType, Rswift.Validatable {
      ...
      let graphVC = StoryboardViewControllerResource<GraphVC>(identifier: "GraphVC")
      ...
      func graphVC(_: Void = ()) -> GraphVC? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: graphVC)
      }
      ...
      static func validate() throws {
        ...
        if UIKit.UIImage(named: "ic_graph_tab", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'ic_graph_tab' is used in storyboard 'BottomTAB', but couldn't be loaded.") }
        ...
        if _R.storyboard.bottomTAB().graphVC() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'graphVC' could not be loaded from storyboard 'BottomTAB' as 'GraphVC'.") }
